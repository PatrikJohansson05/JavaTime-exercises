...
public class Exercises {
    ...
    public static void exercise2(){
        LocalDate march29 = LocalDate.parse("03-25");
        String custom = march29.format(DateTimeFormatter.ofPattern("eeee dd MMM"));
    }
    /*
    ...
    /*
    Exercise5: The date time api provides enums for time units such as day and month. Create a LocalDate of 1945-05-08and extract the day of week for that date.
     */
    ...
    /*
    Exercise7: Using the LocalDate from exercise 6and your birthdate, create a Period between your birthdate and the date from exercise 5.Print out the elapsed years, months and days.
     */
    ...
    /*
    Exercise 14: Using DateTimeFormatter format the LocalDateTime object from exercise 11 to a String that look tile this: torsdag 5 april 10:00
     */
